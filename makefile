...
uberforcer_windows : crypt.o struct.o queue.o parse_args.o bruteforce.o check.o network.o workers_network.o workers.o main.o
	$(CC) $(CFLAGS) -o $(OUT) out/crypt3.o out/struct.o out/queue.o out/parse_args.o out/bruteforce.o out/check.o out/network.o out/workers_network.o out/workers.o out/main.o -lpthread -lws2_32

crypt.o : lib/crypt3.h lib/crypt3.c
	$(CC) -o out/crypt3.o -c lib/crypt3.c -DDEBUG=$(DEBUG)

struct.o : src/struct.h src/struct.c
	$(CC) -o out/struct.o -c src/struct.c -DDEBUG=$(DEBUG)
